'''Author: Yours truly 
    Purpose: Do some cool molar mass equations
    Write main, and make_periodic_table'''
...
def main():
    ...
    symbol_quantity =parse_formula(element, p_table)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    total_mass = compute_molar_mass(symbol_quantity,p_table)
    print(f'{total_mass} grams/mole')
    print(f'{mass/total_mass:.2f} moles')
    if find_element_name(element)!=None:
        print(f'This element is named {find_element_name(element)}')
...
def make_periodic_table():
    periodic_table_dict ={
        ...
        "dave hates you":["dave hates you",	227],
        "Ag" : ["Silver",	107.8682],
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        ...
        atomic_mass = element_dict[1]
        total_mass = total_mass + (atomic_mass * quantity)
    # Return the total mass.
    return total_mass

def find_element_name(user_response):
    name=None
    element_name_dict = {
        ...
        "C12H19OS"  :  "Vitamin B1"  ,
        "ZrSiO4Acetic acid  : CH3COOH":"Zircon (diamond substitute)" ,
        "BaTiSi3O9" : "Benitoite" ,
        "C8H10N4O2" : "Caffeine" ,
        "Ca(OH)2" : "Calcium hydroxide" ,
        "Cl2" : "Chlorine" ,
        ...
        "C19H28O2" : "Testosterone" ,
        "C12H19OS" : "Vitamin B1" ,
        "ZrSiO4" : "Zircon (diamond substitute)" ,
    }
    if user_response in element_name_dict:
        name = element_name_dict[user_response]
    return name 
